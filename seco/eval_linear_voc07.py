...
def eval_linear(args):
    ...
    idx2label = {0: 'person', 1: 'bicycle', 2: 'car', 3: 'motorbike', 4: 'aeroplane', 5: 'bus', 6: 'train', 
                 7: 'boat', 8: 'bird', 9: 'cat', 10: 'dog', 11: 'horse', 12: 'sheep', 13: 'cow', 14: 'bottle', 
                15: 'chair', 16: 'sofa', 17: 'pottedplant', 18: 'diningtable', 19: 'tvmonitor'}
    dataset_val = VOCDataset(args.anno_dir,
                                args.img_val_dir,
                                (224,224),
                                idx2label=idx2label,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_split_dir', type=str)
